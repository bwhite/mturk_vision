...
s.alter_column('amt_video_label', 'users', 'start_time', pycassa.system_manager.DOUBLE_TYPE)
s.alter_column('amt_video_label', 'users', 'end_time', pycassa.system_manager.DOUBLE_TYPE)
s.alter_column('amt_video_label', 'responses', 'start_time', pycassa.system_manager.DOUBLE_TYPE)
s.alter_column('amt_video_label', 'responses', 'end_time', pycassa.system_manager.DOUBLE_TYPE)
