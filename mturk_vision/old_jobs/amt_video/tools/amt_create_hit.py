...
mturk_vision.create_hit('Label image segments for 25 images', description, duration=25 * 60, reward=.20, max_assignments=20, keywords=['image', 'segments'], url='http://api0.picar.us:16000/')
